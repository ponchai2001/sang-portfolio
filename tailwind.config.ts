	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'matrix-glow': {
					'0%': { boxShadow: '0 0 5px hsl(var(--matrix-green) / 0.3)' },
					'100%': { boxShadow: '0 0 25px hsl(var(--matrix-green) / 0.8)' }
				},
				'float': {
				...
				'bounce-glow': {
					'0%, 100%': { transform: 'scale(1)', boxShadow: '0 0 10px hsl(var(--matrix-green) / 0.3)' },
					'50%': { transform: 'scale(1.05)', boxShadow: '0 0 25px hsl(var(--matrix-green) / 0.6)' }
				},
				'rotate-3d': {
